...
function TCPopup(field, palette) {
	...
	o_colWindow = window.open('/webmanager/resources/colorpicker/picker.html', null, "help=no,status=no,scrollbars=no,resizable=no" + move + ",width=" + w + ",height=" + h + ",dependent=yes", true);
